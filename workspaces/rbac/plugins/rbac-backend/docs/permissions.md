...
| Name                      | Resource Type | Policy | Description                                                                                                 | Requirements        |
| ------------------------- | ------------- | ------ | ----------------------------------------------------------------------------------------------------------- | ------------------- |
| kubernetes.clusters.read  |               |        | Allows the user to read Kubernetes clusters information under `/clusters`                                   | catalog.entity.read |
| kubernetes.resources.read |               |        | Allows the user to read Kubernetes resources information under `/services/:serviceId` and `/resources`      | catalog.entity.read |
